...
CodeFile="~/Logica/InfoAdmin.aspx.cs" Inherits="Presentacion_InfoAdmin" Title="Administrador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="AlignHtmlGVinfoadminimagen"> <asp:GridView ID="DV_FotoPerfil" runat="server" AutoGenerateColumns="False" onrowediting="DV_FotoPerfil_RowEditing" 
    ...
    <br />
        <div class="AlignHtmlGVinfoadmin"> <asp:GridView ID="GV_Datos" runat="server" 
        ...
        HorizontalAlign="Center" style="text-align: center" Width="100%">
