<%@ Page Language="C#" MasterPageFile="~/Presentacion/MasterAdmin.master" AutoEventWireup="true" CodeFile="~/Logica/Admin.aspx.cs" Inherits="Presentacion_Admin" Title="Usuarios" %>
            ...
            <asp:GridView ID="GV_MostrarUsuarios" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Datos de Usuario">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="L_Id0" runat="server" Text='<%# Eval("[id_user]") %>' 
                                Visible="False"></asp:Label>
                    ...
                    <asp:CommandField ShowEditButton="True" DeleteText="Eliminar" EditText="Editar" 
                        UpdateText="Aceptar" />
